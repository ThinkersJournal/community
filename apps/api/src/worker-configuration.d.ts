/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: fd2bb326e6d8b82f1cc1cbda7309b0c0)
...
interface __BaseEnv_Env {
	...
	RESEND_LIMITER: RateLimit;
	FOLLOW_LIMITER: RateLimit;
	COMMENT_LIMITER: RateLimit;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "UserSecurityDO" | "NotifyDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_SECRET_KEY" | "POSTMARK_SERVER_TOKEN" | "TEST_ROUTES" | "PURGE_SECRET">> {}
}
